...
namespace Steamworks
{
	public class ISteamParties : SteamInterface
	{
		...
		public static extern uint _GetNumActiveBeacons( IntPtr self );
		...
		public static extern PartyBeaconID_t _GetBeaconByIndex( IntPtr self, uint unIndex );
		...
		public static extern bool _GetBeaconDetails( IntPtr self, PartyBeaconID_t ulBeaconID, ref SteamId pSteamIDBeaconOwner, ref SteamPartyBeaconLocation_t pLocation, IntPtr pchMetadata, int cchMetadata );
		...
		public static extern SteamAPICall_t _JoinParty( IntPtr self, PartyBeaconID_t ulBeaconID );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		public static extern bool _GetNumAvailableBeaconLocations( IntPtr self, ref uint puNumLocations );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		public static extern bool _GetAvailableBeaconLocations( IntPtr self, ref SteamPartyBeaconLocation_t pLocationList, uint uMaxNumLocations );
		...
		public static extern SteamAPICall_t _CreateBeacon( IntPtr self, uint unOpenSlots, ref SteamPartyBeaconLocation_t pBeaconLocation, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchConnectString, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchMetadata );
		...
		public static extern void _OnReservationCompleted( IntPtr self, PartyBeaconID_t ulBeacon, SteamId steamIDUser );
		...
		public static extern void _CancelReservation( IntPtr self, PartyBeaconID_t ulBeacon, SteamId steamIDUser );
		...
		public static extern SteamAPICall_t _ChangeNumOpenSlots( IntPtr self, PartyBeaconID_t ulBeacon, uint unOpenSlots );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		public static extern bool _DestroyBeacon( IntPtr self, PartyBeaconID_t ulBeacon );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		public static extern bool _GetBeaconLocationData( IntPtr self, SteamPartyBeaconLocation_t BeaconLocation, SteamPartyBeaconLocationData eData, IntPtr pchDataStringOut, int cchDataStringOut );
