...
namespace Steamworks
{
	public class ISteamNetworking : SteamInterface
	{
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		public static extern bool _IsP2PPacketAvailable( IntPtr self, ref uint pcubMsgSize, int nChannel );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		public static extern bool _ReadP2PPacket( IntPtr self, IntPtr pubDest, uint cubDest, ref uint pcubMsgSize, ref SteamId psteamIDRemote, int nChannel );
		
		#endregion
		public bool ReadP2PPacket( IntPtr pubDest, uint cubDest, ref uint pcubMsgSize, ref SteamId psteamIDRemote, int nChannel )
		{
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		public static extern bool _AcceptP2PSessionWithUser( IntPtr self, SteamId steamIDRemote );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		public static extern bool _CloseP2PSessionWithUser( IntPtr self, SteamId steamIDRemote );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		public static extern bool _CloseP2PChannelWithUser( IntPtr self, SteamId steamIDRemote, int nChannel );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		public static extern bool _AllowP2PPacketRelay( IntPtr self, [MarshalAs( UnmanagedType.U1 )] bool bAllow );
		
		#endregion
		public bool AllowP2PPacketRelay( [MarshalAs( UnmanagedType.U1 )] bool bAllow )
		{
		...
		public static extern SNetSocket_t _CreateP2PConnectionSocket( IntPtr self, SteamId steamIDTarget, int nVirtualPort, int nTimeoutSec, [MarshalAs( UnmanagedType.U1 )] bool bAllowUseOfPacketRelay );
		
		#endregion
		public SNetSocket_t CreateP2PConnectionSocket( SteamId steamIDTarget, int nVirtualPort, int nTimeoutSec, [MarshalAs( UnmanagedType.U1 )] bool bAllowUseOfPacketRelay )
		{
