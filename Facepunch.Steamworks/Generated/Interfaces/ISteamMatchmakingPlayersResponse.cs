...
namespace Steamworks
{
	public class ISteamMatchmakingPlayersResponse : SteamInterface
	{
		...
		public static extern void _AddPlayerToList( IntPtr self, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchName, int nScore, float flTimePlayed );
		...
		public static extern void _PlayersFailedToRespond( IntPtr self );
		...
		public static extern void _PlayersRefreshComplete( IntPtr self );
