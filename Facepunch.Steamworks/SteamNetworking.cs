...
namespace Steamworks
{
	public class SteamNetworking: SteamSharedClass<SteamNetworking>
	{
		...
		/// Reads in a packet that has been sent from another user via SendP2PPacket..
		/// </summary>
		public static unsafe bool ReadP2PPacket(byte[] buffer, ref uint size, ref SteamId steamid, int channel = 0)
		{
			fixed (byte* p = buffer)
			{
		...
		/// Reads in a packet that has been sent from another user via SendP2PPacket..
		/// </summary>
		public static unsafe bool ReadP2PPacket(byte* buffer, uint cbuf, ref uint size, ref SteamId steamid, int channel = 0)
		{
